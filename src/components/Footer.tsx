...
export function Footer() {
  return (
    <footer className="bg-primary border-t border-border/40 mt-auto w-full text-white selection:bg-accent selection:text-white">
      <section
        className="w-full bg-primary text-white py-site-margin md:py-32 lg:py-40 flex flex-col items-center justify-center border-b border-border/40 overflow-hidden relative"
