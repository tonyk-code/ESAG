  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-center">
        <div className="w-full lg:w-[90%] grid grid-cols-1 lg:grid-cols-2 relative border-b border-border lg:border-b-0">
          <div className="hidden lg:block absolute top-0 left-[-5%] right-[-5%] h-px bg-border" />

          <div className="hidden lg:block absolute top-0 left-1/2 w-px h-full bg-border" />
          ...
          >
            ...
            <h2 className="font-display font-black text-primary text-5xl md:text-6xl lg:text-7xl uppercase leading-[0.95] tracking-tighter mb-10 whitespace-pre-line">
              Ethiopia's{"\n"}film house.
            </h2>
            <Link
              to="/about"
              className="inline-flex items-center justify-center px-8 py-4 bg-accent hover:bg-accent-hover text-canvas font-mono font-bold uppercase tracking-wider text-sm transition-colors duration-300 shadow-md"
            >
              About Us
            </Link>
          </motion.div>
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ type: "spring", stiffness: 60, damping: 20 }}
            className="py-12 pt-12 md:py-20 lg:py-28 lg:pt-28 flex flex-col justify-center lg:pl-16 border-t border-border lg:border-t-0"
          >
            <div className="max-w-xl">
              <p className="font-body text-secondary text-base md:text-lg leading-relaxed whitespace-pre-line">
